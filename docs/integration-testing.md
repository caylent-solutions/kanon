...
`.github/actions/setup-kanon`. The kanon devcontainer also sets it
...
# kanon repo resolves the project URL to .../cs-catalog/catalog -- a bare
# git repo must exist at that sub-path.
#

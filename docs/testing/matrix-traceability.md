...
| 8 | list / format-json | coverage | PASS | `tests/integration/test_list_format_json.py::TestDefaultModeJsonFormat::test_three_entries_produce_three_element_array`, `tests/integration/test_list_format_json.py::TestDefaultModeJsonFormat::test_json_output_is_parseable_by_json_loads` |

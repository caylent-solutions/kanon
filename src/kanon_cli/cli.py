...
Global options (always available):
  ...
  --allow-abs-root <path>        Additionally permit an absolute <linkfile>/<copyfile> dest under <path> (repeatable).
                                 The project root and CLAUDE_MARKETPLACES_DIR are always permitted. Precedence: flag > KANON_ALLOWED_ABS_ROOTS env.
